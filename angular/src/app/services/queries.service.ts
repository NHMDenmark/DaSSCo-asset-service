...
export class QueriesService {
  ...
  nodeProperties$ = this.oidcSecurityService
    ...
    .pipe(
      switchMap((token) =>
        this.http
          .get<Map<string, string[]>>(`${this.baseUrl}/nodes`, {headers: {'Authorization': 'Bearer ' + token}})
          .pipe(catchError(this.handleError(`get ${this.baseUrl}/nodes`, undefined)))
      )
    );
  ...
  queryItems$ = this.oidcSecurityService
    ...
    .pipe(
      switchMap((token) =>
        this.http
          .get<QueryItem[]>(`${this.baseUrl}/nodes`, {headers: {'Authorization': 'Bearer ' + token}})
          .pipe(catchError(this.handleError(`get ${this.baseUrl}/nodes`, undefined)))
      )
    );
  ...
  savedQueries$ = this.oidcSecurityService
    ...
    .pipe(
      switchMap((token) =>
        this.http
          .get<SavedQuery[]>(`${this.baseUrl}/saved`, {headers: {'Authorization': 'Bearer ' + token}})
          .pipe(catchError(this.handleError(`get ${this.baseUrl}/nodes`, undefined)))
      )
    );
    ...
    return this.oidcSecurityService.getAccessToken().pipe(
      switchMap((token) =>
        this.http
          ...
          .pipe(catchError(this.handleError(`get ${this.baseUrl}/save`, undefined)))
      )
    );
  }
    ...
    return this.oidcSecurityService.getAccessToken().pipe(
      switchMap((token) =>
        this.http
          ...
          .pipe(catchError(this.handleError(`get ${this.baseUrl}/${limit}`, undefined)))
      )
    );
  }
    ...
    return this.oidcSecurityService.getAccessToken().pipe(
      switchMap((token) =>
        this.http
          ...
          .pipe(catchError(this.handleError(`get ${this.baseUrl}/${title.trim()}`, undefined)))
      )
    );
  }
