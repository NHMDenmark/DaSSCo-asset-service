...
SELECT * from cypher('dassco', $$
    ...
    MATCH(i:Institution {name: "institution_1"})
    MATCH(c:Collection {name: "i1_c1"})
    MATCH(w:Workstation {name: "i1_w1"})
    MATCH(p:Pipeline {name: "i1_p1"})
...
SELECT * from cypher('dassco', $$
    ...
    MATCH(c:Collection {name: "i2_c1"})
    MATCH(w:Workstation {name: "i2_w1"})
    MATCH(p:Pipeline {name: "i2_p1"})
