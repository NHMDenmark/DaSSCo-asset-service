...
public record DasscoFile(
        ...
        boolean deleted,
        Integer specifyAttachmentId) {
    @JdbiConstructor
    public DasscoFile(Long fileId, String assetGuid, String path, long sizeBytes, long crc, boolean deleteAfterSync, FileSyncStatus syncStatus, boolean deleted,
                      Integer specifyAttachmentId) {
        this.fileId = fileId;
