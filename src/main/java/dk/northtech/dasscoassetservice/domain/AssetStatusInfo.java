...
public record AssetStatusInfo(
    ...
    public AssetStatusInfo(String asset_guid, Set<String> parent_guid, Instant error_timestamp, InternalStatus status, String error_message) {
