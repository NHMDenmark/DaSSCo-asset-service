...
public class AssetServiceX {
    ...
    @Inject
    public AssetServiceX(InstitutionService institutionService
...
//        });
//
//        List<Asset> bulkUpdateSuccess = jdbi.onDemand(BulkUpdateRepository.class).bulkUpdate(sql, builder, updatedAsset, event, assets, assetList);
//
...
//        this.statisticsDataServiceV2.addAssetToCache(asset);
    ...
    public List<Asset> readMultipleAssets(List<String> assets) {
        return jdbi.onDemand(BulkUpdateService.class).readMultipleAssets(assets);
    }
