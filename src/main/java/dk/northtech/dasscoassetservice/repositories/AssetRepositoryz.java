...
//@Repository
public interface AssetRepositoryz extends SqlObject {
//    private Jdbi jdbi;
        ...
        String sql =
                """
                        ...
                        , $$
                            ...
                            MATCH (as:Asset_subject{name: $asset_subject})
                            MATCH (is:Internal_status{name: $internal_status})
                            ...
                            MERGE (a)-[ahp:HAS]->(pt:Payload_type{name: $payload_type})
                            MERGE (a)-[ahs:HAS]->(s)
                            MERGE (a)-[aha:HAS]->(ab:Asset_subject{name: $asset_subject})
                            MERGE (a)-[ahi:HAS]->(is)
